      ...
      <div className="bg-[#0A0F13] flex flex-row justify-end border-2 border-[#202327] p-4 gap-x-4 w-[80%]">
        ...
        {showPanel ? (
          <div className="flex flex-row gap-x-6 rounded-sm items-center justify-center w-[35%]">
            <Button className="bg-[#112431] hover:bg-[#112431]/80 rounded-md border-2 border-[#aaabac] hover:scale-105">
              <Link className="text-[#2EA2E6]" href="/profile">
                Profile
              </Link>
            </Button>
            <Button className="bg-[#112431] hover:bg-[#112431]/80 rounded-md border-2 border-[#aaabac] hover:scale-105">
              <Link className="text-[#2EA2E6]" href="/plan">
                User Plan
              </Link>
            </Button>
            <Button
              onClick={signOut}
              className="bg-[#112431] hover:bg-[#112431]/80 rounded-md border-2 border-[#aaabac] hover:scale-105 hover:cursor-pointer text-[#2EA2E6]"
            >
              Logout
            </Button>
            <Button
              ...
              className="bg-[#112431] rounded-md border-2 border-[#aaabac] text-[#2EA2E6] hover:scale-105 hover:bg-[#112431]/80 hover:cursor-pointer"
            >
              Cancel
            </Button>
          </div>
          ...
          <Button
            ...
            className="bg-[#112431] rounded-full text-[#2EA2E6] hover:cursor-pointer hover:bg-[#112431]/80"
          >
            {userInitials}
          </Button>
        )}
