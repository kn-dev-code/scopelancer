    ...
    <>
      <div className="border-2 border-[#22272C] bg-[#0D1218] flex flex-col justify-between h-screen w-[20%] p-9 relative bottom-[8%]">
        ...
        <div className="flex flex-col justify-between gap-y-6">
          ...
          <Link
            className="hover:transition hover:duration-500 hover:ease-in-out hover:rounded-2xl w-full active:bg-[#1F2F3E] bg-[#0D1218] hover:cursor-pointer"
            href="/dashboard"
          >
            <Button className="text-[#9199A2] flex flex-row justify-start active:bg-[#1F2F3E] bg-[#0D1218] hover:cursor-pointer">
              <LayoutDashboardIcon />
              Dashboard
            </Button>
          </Link>
          <Link
            ...
            href="/sessions"
          >
            <Button className="text-[#9199A2] flex flex-row justify-start bg-[#0D1218] active:bg-[#1F2F3E] hover:cursor-pointer">
              <FolderOpenIcon />
              Sessions
            </Button>
          </Link>
